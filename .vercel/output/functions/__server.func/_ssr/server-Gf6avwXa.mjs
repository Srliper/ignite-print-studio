...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-CnYL5OvW.mjs");
...
const manifest = {
  "02724b713dc9c559f2c80c7cf125e42c644f38894fb73bce595b85b119e86b45": {
    ...
    importer: () => import("./admin.functions-CyP3EPpu.mjs")
  },
  ...
  "3a033da0b2908233e28b4239931b49889f82a4ac50cd310935a57b5ebc6e1593": {
    ...
    importer: () => import("./pedidos.functions-D0GgvcJZ.mjs")
  },
  ...
  "a5bd66eb4dc18e634193e8cd2782a09e2ce407953c06bc3b2e156f0191a637c9": {
    ...
    importer: () => import("./auth-session-CAg9Cjqc.mjs")
  },
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-BlUzkigm.mjs").then((n) => n.r),
    import("./start-DHkUSlyr.mjs"),
