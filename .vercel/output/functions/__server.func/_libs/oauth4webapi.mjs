...
const allowInsecureRequests = /* @__PURE__ */ Symbol();
const clockSkew = /* @__PURE__ */ Symbol();
const clockTolerance = /* @__PURE__ */ Symbol();
const customFetch = /* @__PURE__ */ Symbol();
const modifyAssertion = /* @__PURE__ */ Symbol();
const jweDecrypt = /* @__PURE__ */ Symbol();
...
async function resourceRequest(accessToken, method, url, headers, body, options) {
  ...
  const response = await (options?.[customFetch] || fetch)(url.href, {
    duplex: looseInstanceOf(body, ReadableStream) ? "half" : void 0,
    body,
    headers: Object.fromEntries(headers.entries()),
    method,
    redirect: "manual",
...
const skipSubjectCheck = /* @__PURE__ */ Symbol();
...
const expectNoNonce = /* @__PURE__ */ Symbol();
const skipAuthTimeCheck = /* @__PURE__ */ Symbol();
...
const skipStateCheck = /* @__PURE__ */ Symbol();
const expectNoState = /* @__PURE__ */ Symbol();
...
const _nodiscoverycheck = /* @__PURE__ */ Symbol();
const _expectedIssuer = /* @__PURE__ */ Symbol();
export {
  AuthorizationResponseError as A,
  ClientSecretJwt as C,
  None as N,
  PrivateKeyJwt as P,
  generateRandomCodeVerifier as a,
  generateRandomNonce as b,
  calculatePKCECodeChallenge as c,
  discoveryRequest as d,
  customFetch as e,
  ClientSecretPost as f,
  generateRandomState as g,
  authorizationCodeGrantRequest as h,
  processAuthorizationCodeResponse as i,
  getValidatedIdTokenClaims as j,
  processUserInfoResponse as k,
  allowInsecureRequests as l,
  modifyAssertion as m,
  processDiscoveryResponse as p,
  skipStateCheck as s,
  userInfoRequest as u,
  validateAuthResponse as v
};
